...
// Hardware SSE4.2 path with runtime detection, software slice-by-8 fallback.
//
...
uint32_t crc32cHw(uint32_t crc, const void* data, size_t len); // 0-filled stub if !x86_64
